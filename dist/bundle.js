...
const fullscreen_1 = __webpack_require__(12);
const Timeline_1 = __webpack_require__(17);
const Search_1 = __webpack_require__(20);
const Clip_1 = __webpack_require__(24);
class App extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(fullscreen_1.FullScreen, null,
            React.createElement(Search_1.Search, { search: (searchText) => { this.setState({ searchText }); } }),
            React.createElement("div", { className: "app-wrapper" }, clips.map((clip, index) => {
                if (searchText == "" || clip.name.toLowerCase().includes(searchText.toLowerCase())) {
                    ...
                    return React.createElement(Clip_1.Clip, { key: clip.category + "_" + clip.name, name: clip.name, url: clip.url, category: clip.category, newCategory: newCat });
                }
            })),
            React.createElement(Timeline_1.Timeline, null)));
    }
}
exports.App = App;
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __webpack_require__(0);
const Dropzone = __webpack_require__(13);
class FullScreen extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(Dropzone, { disableClick: true, accept: "audio/mp3", onDrop: this.onDrop.bind(this), onDragEnter: this.onDragEnter.bind(this), onDragLeave: this.onDragLeave.bind(this), className: dropzoneActive ? "dropzone active" : "dropzone" }, this.props.children));
    }
}
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __webpack_require__(0);
const classNames = __webpack_require__(18);
const OutsideAlerter_1 = __webpack_require__(19);
class Timeline extends React.Component {
    ...
    render() {
        return (React.createElement(OutsideAlerter_1.OutsideAlerter, { clickedOutside: () => { this.setState({ hasFocus: false }); } },
            React.createElement("div", { className: classNames("timeline-root", { "timeline-active": this.state.hasFocus }), onClick: () => this.setState({ hasFocus: true }) },
                "?",
                this.props.children)));
    }
}
...
class Search extends React.Component {
    ...
    render() {
        return (React.createElement("input", { type: "text", onChange: (e) => this.searchPerformed(e), className: "search-input", autoFocus: true }));
    }
}
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __webpack_require__(0);
const CopyToClipboard = __webpack_require__(25);
const Progress_Bar_1 = __webpack_require__(29);
    ...
    render() {
        return (React.createElement("div", { className: "clip-outer-wrapper" },
            ...
            React.createElement("div", { className: "clip-inner-wrapper" + (this.state.isPlaying ? " clip-playing" : "") },
                ...
                React.createElement(CopyToClipboard, { text: this.props.url.replace(new RegExp(" ", "g"), "%20"), onCopy: () => this.handleCopy() },
                    React.createElement("button", { className: "copy-button" },
                        React.createElement(Progress_Bar_1.Progress, { progress: this.state.progress, length: this.audio.duration }))),
                this.state.copied && React.createElement("span", { className: "copy-label" }, "Copied"))));
    }
}
exports.Clip = Clip;
...
var _copyToClipboard = __webpack_require__(27);
...
var deselectCurrent = __webpack_require__(28);
...
class Progress extends React.Component {
    ...
    render() {
        ...
        const progressBar = React.createElement("div", { className: "progress-bar", style: barStyle });
        return (React.createElement("div", { className: "progress" }, progressBar));
    }
}
